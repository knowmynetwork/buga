...
class _EmergencyContactFormState extends State<EmergencyContactForm> {
  ...
  void _removeEmergencyContact(int index) {
    setState(() {
      _emergencyContacts[index]['nameController']?.removeListener(_onInputChanged);
      _emergencyContacts[index]['relationshipController']?.removeListener(_onInputChanged);
      _emergencyContacts[index]['phoneController']?.removeListener(_onInputChanged);
      _emergencyContacts[index]['altPhoneController']?.removeListener(_onInputChanged);
