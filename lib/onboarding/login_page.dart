...
import 'package:buga/onboarding/forget_password.dart'; // Import the forgot password screen
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                TextButton(
                  onPressed: () {
                    Navigator.pushNamed(context, '/forgot'); // Navigate to ForgotPasswordScreen
                  },
