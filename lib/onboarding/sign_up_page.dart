...
class DriverAccountForm extends StatefulWidget {
  @override
  _DriverAccountFormState createState() => _DriverAccountFormState();
}

class _DriverAccountFormState extends State<DriverAccountForm> {
              ...
              children: [
                ...
                _buildInputField(
                  ...
                  validator: (value) {
                    ...
                    if (!RegExp(r'^\+?\d{10,15}$').hasMatch(value)) { // Nigerian phone number validation
